...
// Per Vercel docs, `export const config = { maxDuration }` only takes
// effect for API routes on Pages Router. SSG/ISR pages need the
// `functions` block in vercel.json. Kept here as a harmless hint.
export const config = {
  maxDuration: 300
}
